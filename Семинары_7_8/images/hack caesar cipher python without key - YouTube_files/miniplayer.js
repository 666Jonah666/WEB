...
g.k.uE=function(){this.tooltip=new g.wQ(this.player,this);g.I(this,this.tooltip);g.JM(this.player,this.tooltip.element,4);this.tooltip.scale=.6;this.uc=new g.PN(this.player);g.I(this,this.uc);this.Dg=new g.W({G:"div",L:"ytp-miniplayer-scrim"});g.I(this,this.Dg);this.Dg.Da(this.element);this.T(this.Dg.element,"click",this.mA);var a=new g.W({G:"button",Ga:["ytp-miniplayer-close-button","ytp-button"],W:{"aria-label":"\u0417\u0430\u043a\u0440\u044b\u0442\u044c"},U:[g.QK()]});g.I(this,a);a.Da(this.Dg.element);
this.T(a.element,"click",this.Di);a=new g.V1(this.player,this);g.I(this,a);a.Da(this.Dg.element);this.yp=new g.W({G:"div",L:"ytp-miniplayer-controls"});g.I(this,this.yp);this.yp.Da(this.Dg.element);this.T(this.yp.element,"click",this.mA);var b=new g.W({G:"div",L:"ytp-miniplayer-button-container"});g.I(this,b);b.Da(this.yp.element);a=new g.W({G:"div",L:"ytp-miniplayer-play-button-container"});g.I(this,a);a.Da(this.yp.element);var c=new g.W({G:"div",L:"ytp-miniplayer-button-container"});g.I(this,c);
c.Da(this.yp.element);this.hN=new g.nP(this.player,this,!1);g.I(this,this.hN);this.hN.Da(b.element);b=new g.lP(this.player,this);g.I(this,b);b.Da(a.element);this.nextButton=new g.nP(this.player,this,!0);g.I(this,this.nextButton);this.nextButton.Da(c.element);this.Gg=new g.hQ(this.player,this);g.I(this,this.Gg);this.Gg.Da(this.Dg.element);this.Fc=new g.uP(this.player,this);g.I(this,this.Fc);g.JM(this.player,this.Fc.element,4);this.aA=new g.W({G:"div",L:"ytp-miniplayer-buttons"});g.I(this,this.aA);
g.JM(this.player,this.aA.element,4);a=new g.W({G:"button",Ga:["ytp-miniplayer-close-button","ytp-button"],W:{"aria-label":"\u0417\u0430\u043a\u0440\u044b\u0442\u044c"},U:[g.QK()]});g.I(this,a);a.Da(this.aA.element);this.T(a.element,"click",this.Di);a=new g.W({G:"button",Ga:["ytp-miniplayer-replay-button","ytp-button"],W:{"aria-label":"\u0417\u0430\u043a\u0440\u044b\u0442\u044c"},U:[g.VK()]});g.I(this,a);a.Da(this.aA.element);this.T(a.element,"click",this.wV);this.T(this.player,"presentingplayerstatechange",
